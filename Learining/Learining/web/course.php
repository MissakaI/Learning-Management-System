            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12" id="view-books">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>All Courses
                                    <small>List of currently available courses</small>
                                </h2>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <tr class="headings">
                                            ...
                                            <th class="column-title">Prerequisite course code</th>
                ...
                <div class="row" id="add-book">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Enter Course Details
                                    <small>Add new course to the system.</small>
                                </h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Credit hours:
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">College: <span
                                    ...
                                    <div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Prerequisite course code: <span
                                                        class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="author" type="text" name="country"
                                                       class="form-control col-md-10 autocomplete-custom-append"/>
                                    ...
                                    <div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Department Code: <span
                                                        class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="author" type="text" name="country"
                                                       class="form-control col-md-10 autocomplete-custom-append"/>
