                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="manage-student.php"><i class="fa fa-home"></i> Home</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="course" type="text" name="country"
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" checked="" value="option1" id="optionsRadios1"
                                                       name="optionsRadios">Undergraduate
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" value="option2" id="optionsRadios2"
                                                       name="optionsRadios"> Graduate
                                            </label>
                                        </div>
                                    </div>
                                    <br><br>
