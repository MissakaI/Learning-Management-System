...
<div class="container body">
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="manage-student.php"><i class="fa fa-home"></i> Home <span
                                            class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="root.php">aa</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="right_col" role="main">
            ...
            <div class="row" id="add-student">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Enter Student Section Details
                                <small>Add new Student section to the system.</small>
                            </h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="studentid" required="required"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="studentname" name="last-name" required="required"
                                               class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="status" type="text" name="country"
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" checked="" value="option1" id="typeUndergratuated"
                                                           name="undergraduate">Undergraduate
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" value="option2" id="typeGratuated"
                                                           name="graduate"> Graduate
                                                </label>
                                            </div>
                                        </div>
                                        <br><br>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        ...
                                        <button type="submit" class="btn btn-success" id="submit" onclick="send_details()">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        function send_details() {
            ...
            xhttp.send("StudentID=" + $("#empa-id").val() + "&Name=" + $("#name").val() + "&Address=" + $("#office").val() + "&Status=" + $("#mobile").val() + "&Type=" + $("#dep-code:selected").text() + "&action=add");
        }
