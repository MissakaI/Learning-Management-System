                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="course-section.php"><i class="fa fa-home"></i> Home <span
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div>
                            <button type="submit" class="btn btn-success"><a href="add-course-section.php">Add New</a>
                            </button>
                        </div>

                        <h2>View All Course Sections</small></h2>
