                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-book"></i> Manage Lab Session <span
                                            class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a onclick="navClick('add')">Enter Lab Session Details</a></li>
                                    <li><a onclick="navClick('view')">View All Lab Session Details</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12" id="view-books">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>All Books
                                    <small>List of currently available lab sessions</small>
                                </h2>
                            ...
                            <div class="x_content">
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <tr class="headings">
                                            ...
                                            <th class="column-title">Lab Session Number</th>
                                ...
                                <div class="form-group">
                                    <div class="col-md-2 col-sm-2 col-xs-12 col-sm-offset-9 col-md-offset-9 col-lg-offset-10">
                                        <button type="button" class="btn btn-danger left">Remove Selected Session(s)
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row" id="add-book">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Enter Lab Session Details
                                    <small>Add new lab session to the system.</small>
                                </h2>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Lab
                                            Session Number: <span class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Lab:
                                    ...
                                    <div class="form-group">
                                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Time:
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Topic: <span
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Course Section: <span
                                                    class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="author" type="text" name="country"
                                                   class="form-control col-md-10 autocomplete-custom-append"/>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Graduate: <span
                                                    class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="author" type="text" name="country"
                                                   class="form-control col-md-10 autocomplete-custom-append"/>
