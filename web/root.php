                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="proffessor.php"><i class="fa fa-home"></i> Professor <span
                                            class="fa fa-chevron-down"></span></a></li>
                            <li><a href="department.php"><i class="fa fa-home"></i> Department <span
                                            class="fa fa-chevron-down"></span></a></li>
                            <li><a href="company.php"><i class="fa fa-home"></i> Company <span
                                            class="fa fa-chevron-down"></span></a></li>
                        </ul>
                    </div>
                </div>
